...
function viewModel() {
    ...
    self.locations = ko.observableArray([
            ...
            {cat: 'places', name: 'Shoreditch High Street station', address: '', city: 'london', lat: NaN, long: NaN, description: '', url: '', img: ''},
            ...
            {cat: 'places', name: 'City of London', address: '', city: 'london', lat:NaN, long: NaN, description: '', url: '', img: ''},
        ...
        ko.utils.arrayForEach (self.locations(), function(location) {
            ...
            geocoder.geocode( { 'address': locaddress}, function(results, status) {
                  if (status == google.maps.GeocoderStatus.OK) {
                      var latlng = {lat: results[0].geometry.location['k'], lng:results[0].geometry.location['D']};
    ...
    // TODO: DOVE CAZZO SI METTONO I BOUNDS???
