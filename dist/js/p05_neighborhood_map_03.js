    ...
    try {
        ...
        var ViewModel = function(Model,mapObject) {
            ...
            '&v=20150101&ll=' + self.mainLocation().lat + ',' + self.mainLocation().lng +
             ...
             .fail(function(e) {
                alert('We are experiencing problems with the FourSquare interface. We apologise for the ' +
            ...
            var showMap = (function() {
                ...
                try {
                    ...
                    alert('We are experiencing problems with the Google Maps interface. ' +
